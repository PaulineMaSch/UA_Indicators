...
# reclassifying the land use column with the UA Code in their five 1-level categories in a new column
...
def plot_results():
    """Creates a stacked bar chart of the results"""
    ...
    plt.xticks(Pos, label_array,rotation='vertical')
